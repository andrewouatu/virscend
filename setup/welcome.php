	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '8  New Features', 'vibe' ); ?></h4>
						<p><?php _e( 'We\'ve added a lot of small features and improvements in WPLMS. A lot of feature requests have been added based on user feedback. Below are some of the major ones.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-4/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Features & Improvements', 'vibe' ); ?></h4>
						<p><?php _e( 'We added major improvemnts for quizzes, check question answer instantly feature, quiz submission improvement and multiple fillblank and selectdrop down.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-4/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Instantly Check Question Answers', 'vibe' ); ?></h4>
						<p><img src="http://i0.wp.com/i.gyazo.com/cff9abe46c7cfb9855c8ad57a0f890a7.gif?resize=920%2C418&ssl=1" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/instant-questionwitch-in-quizzes/" target="_blank" class="button">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Multiple FillBlank , Select Question Type', 'vibe' ); ?></h4>
						<p><img src="http://i2.wp.com/i.gyazo.com/41631739380d1e10bc4b5704258817c4.gif?resize=884%2C266&ssl=1" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/multiple-fillblank-and-multiple-select-dropdown-question-types" target="_blank" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Survey Question types', 'vibe' ); ?></h4>
						<p><img src="http://i0.wp.com/i.gyazo.com/222a11eab9ed7c32531d46e342d0bab4.gif" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/survey-question-type/" target="_blank" class="button">Tutorial</a>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Page Loading Effects', 'vibe' ); ?></h4>
						<p><img src="http://i0.wp.com/i.gyazo.com/ddb42926b2006602d81b060e02ae3306.gif" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-page-loading-effects/" target="_blank" class="button">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Course Filters : Auto filter', 'vibe' ); ?></h4>
						<p><img src="http://i1.wp.com/i.gyazo.com/bbb2ceccb84d1d72a851ac2a4d0fe8c3.gif?resize=920%2C522&ssl=1" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/course-filters-auto-filter-switch/" target="_blank" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Instructor Profile in Courses', 'vibe' ); ?> </h4>
						<p><img src="http://i1.wp.com/i.gyazo.com/df2669416ea6ad383dd1dd83f5cdcf5f.gif?resize=848%2C540&ssl=1" /></p>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'BuddyDrive 2.0', 'vibe' ); ?></h4>
						<p><img src="https://i.gyazo.com/a8d746ac2a6d58b2ed256233a8b2a03a.gif" /></p>
					</div>
					<div>
						<h4><?php _e( 'Forum Course connectivity', 'vibe' ); ?></h4>
						<p><img src="http://image.prntscr.com/image/dd79bc07d8314457b7e381fd22209e84.png" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base//course-forum-connectivity-back-to-course-in-forums" target="_blank" class="button" >Tutorial</a>
					</div>
					
					<div class="last-feature">
						<h4><?php _e( 'Events Display option', 'vibe' ); ?></h4>
						<p><img src="http://image.prntscr.com/image/28865262978741a78d4104fddbde2d5a.png" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/course-events-display-style/" target="_blank" class="button" >Tutorial</a>
					</div>
				</div>
			</div>
			<div class="changelog">
				...
				<div class="feature-section col three-col">
					...
					<div class="last-feature">
						...
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-3/"><?php _e( 'Check Translation files status','vibe'); ?></a>
					</div>
				</div>
			</div>
			<div class="return-to-dashboard">
