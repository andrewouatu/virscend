        ...
        switch($location){
            ...
            case 'header':
                ...
                if(in_array($header,array('sleek','transparent','center','generic'))){
                    $url .='" id="header_logo"><img id="header_mobile_logo" src="'.$mobile_logo.'" class="hide" alt="'.$alt.'"><img id="header_alt_logo" alt="'.$alt.'" src="'.$alt_logo;    
                }else{
                    if(!empty($alt_logo)) 
                        $url .= '" data-alt-logo="'.$alt_logo; 

                    if(!empty($mobile_logo)) 
                        $url .= '" id="header_logo"><img id="header_mobile_logo" alt="'.$alt.'" src="'.$mobile_logo.'" class="hide';
                }
            ...
            case 'headertop':
                ...
                $mobile_logo = vibe_get_option('mobile_logo');
                if(!empty($alt_logo)) 
                    $url = $alt_logo.'" id="header_logo"><img id="header_mobile_logo" alt="'.$alt.'" src="'.$mobile_logo.'" class="hide';
            break;
        }
    }
    if(is_ssl()){
...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.2.7.2.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/bbpress.2.5.11.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
